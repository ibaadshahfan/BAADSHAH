...
3) ᴍᴏᴠɪᴇ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ ʀᴇᴘᴏʀᴛ ᴛᴏ ᴀᴅᴍɪɴs</b>"""
    ...
    MVE_NT_FND = """<b>𝑻𝒉𝒊𝒔 𝑴𝒐𝒗𝒊𝒆 𝑵𝒐𝒕 𝑭𝒐𝒖𝒏𝒅 𝑰𝒏 𝑴𝒚 𝑫𝒂𝒕𝒂𝑩𝒂𝒔𝒆...😌\n\n<blockquote>ಈ ಮೂವಿ 𝑫𝒂𝒕𝒂𝒃𝒂𝒔𝒆ನಲ್ಲಿ ಇಲ್ಲ...😌</blockquote></b>"""
...
➢ QR Cᴏᴅᴇ : <a href='https://envs.sh/QNp.jpg'>𝑪𝑳𝑰𝑪𝑲 𝑯𝑬𝑹𝑬 𝑻𝑶 𝑺𝑪𝑨𝑵</a>

➢ Uᴘɪ Iᴅ :  <a href='https://t.me/CINEHUBPREMIUMBOT'>𝙲𝙾𝙽𝚃𝙰𝙲𝚃 𝙷𝙴𝚁𝙴</a>
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/kannada_cine_hub">{file_name}</a></b>\n\n<b>⚜️ ᴊᴏɪɴ ʜᴇʀᴇ ғᴏʀ ʟᴀᴛᴇsᴛ ᴜᴘᴅᴀᴛᴇ :@Kannada_cine_hub</a></b>"""
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/CINEHUBPREMIUMBOT'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
💵 ᴜᴘɪ ɪᴅ - <a href='https://t.me/CINEHUBPREMIUMBOT'>𝙲𝙾𝙽𝚃𝙰𝙲𝚃 𝙷𝙴𝚁𝙴</a>
...
📸 ǫʀ ᴄᴏᴅᴇ - <a href='https://envs.sh/QNp.jpg'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a>
...
⚜️ 120 𝑹𝒖𝒑𝒂𝒚𝒆 👉 60 𝒅𝒂𝒚𝒔</blockquote>

𝑺𝒆𝒍𝒆𝒄𝒕 𝒀𝒐𝒖𝒓 𝑷𝒂𝒚𝒎𝒆𝒏𝒕 𝑴𝒆𝒕𝒉𝒐𝒅.....

𝑼𝑷𝑰 𝑰𝑫 👉 <a href='https://t.me/CINEHUBPREMIUMBOT'>𝙲𝙾𝙽𝚃𝙰𝙲𝚃 𝙷𝙴𝚁𝙴</a>

𝑸𝑹 𝒄𝒐𝒅𝒆 👉 <a href='https://envs.sh/QNp.jpg'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a> 
...
‼️ 𝑨𝒇𝒕𝒆𝒓 𝑺𝒆𝒏𝒅𝒊𝒏𝒈 𝑨 𝑺𝒄𝒓𝒆𝒆𝒏𝒔𝒉𝒐𝒕 𝑷𝒍𝒆𝒂𝒔𝒆 𝑮𝒊𝒗𝒆 𝒖𝒔 𝒔𝒐𝒎𝒆 𝑻𝒊𝒎𝒆 𝑻𝒐 𝑨𝒅𝒅 𝒀𝒐𝒖 𝑰𝒏 𝑻𝒉𝒆 𝑷𝒓𝒆𝒎𝒊𝒖𝒎 𝑳𝒊𝒔𝒕.</b>"""    
 ...
 ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a href=https://t.me/Kannada_Cinehub>𝘒𝘈𝘕𝘕𝘈𝘋𝘈 𝘊𝘐𝘕𝘌𝘏𝘜𝘉</a> """
