...
PICS = (environ.get('PICS', 'https://envs.sh/asv.jpg https://envs.sh/asg.jpg https://envs.sh/asH.jpg https://envs.sh/asN.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://i.ibb.co/9HPnsdMt/photo-2025-12-09-04-41-41-7581713842720210960.jpg")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '565220764 6390511215').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002462127875 -1002513468455').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002495434730'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002495434730'))  # Bin channel id (make sure bot is admin)
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002412376700'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002495434730'))  # Premium logs channel id
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1001607709250').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1001607709250 -1002257054222').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/QNp.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'ASK THE OWNER 👍')

# ============================
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vishnuabhyantha:Jrpw9148@cluster0.glqwz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://prajwaludaykumar:GzoBSZRLmcYinwQw@cluster0.vha5j.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Kannadapirates")
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002495434730'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/Anylinkstutorials/15')  # How to open tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+pXcnPPXfkR43ZjFl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Kannada_Cine_Hub')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Kannada_Cine_Hub')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+ltVCdIRxgjA3ZDhl')
OWNERID = int(os.environ.get('OWNERID', '565220764'))  # Replace with the actual admin ID

# ============================
# User Configuration
# ============================
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6390511215 565220764').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+kAIk5iNvh25lMTY9')  # Support group link (make sure bot is admin)
